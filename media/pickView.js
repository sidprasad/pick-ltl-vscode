...
(function() {
    ...
    window.initializePickView = function(vscodeApi) {
        ...
        function buildMatchPopover(matches, headingText) {
            ...
            heading.textContent = headingText || 'Matching candidates';
        ...
        function createMatchInfoControls(matches, headingText, extraButtonClass) {
            ...
            button.title = 'Show which candidates accept this trace';
            button.innerHTML = '?';
        ...
        window.addEventListener('message', function(event) {
            ...
            switch (message.type) {
                ...
                case 'newPair':
                    ...
                    showWordPair(message.pair, message.status, message.matches, message.renderData);
                    break;
                case 'wordClassified':
        ...
        function showWordPair(pair, status, pairMatches, renderData) {
            ...
            if (renderData) { lastRenderData = renderData; }
            clearHistoryNotice();
            closeMatchPopovers();
        ...
        function updateWordHistory(history) {
            ...
            if (!history || history.length === 0) {
                historyItems.innerHTML = '<p style="color: var(--vscode-descriptionForeground); font-style: italic;">No traces classified yet.</p>';
                return;
            }
        ...
        function decorateWordCardsWithMatches(history, fallbackMatches) {
            ...
            cards.forEach(function(card) {
                ...
                const info = createMatchInfoControls(matches, `Matching candidates for "${word}"`, 'word-info-btn');
        ...
        function showNoRegexFound(message, candidateDetails, inWords, outWords, wordHistory) {
            ...
            addHistoryNotice('No formula survived. Revise your description to generate new candidates — your existing classifications are preserved below.');
