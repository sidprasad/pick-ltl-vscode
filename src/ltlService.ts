...
export async function generateLtlFromDescription(
  ...
  const messages: vscode.LanguageModelChatMessage[] = [
    ...
    [
      ...
      "- Atom (proposition) names must be SHORT and match [a-z0-9]+ : lowercase letters and digits ONLY. No uppercase, spaces, underscores, hyphens, camelCase, or punctuation.",
      "- Keep each atom to a single short word or abbreviation (about 1-8 characters), e.g. 'e', 'hl', 'req', 'grant1'. GOOD: 'engine' -> 'e' or 'eng'. BAD: 'EngineOn', 'engine_on', 'engine on', 'headLight', 'isRequestGranted'.",
      "- An atom is one atomic condition, never a phrase or a whole sub-property. Use the SAME name everywhere it appears, and declare every atom used in a formula in \"atoms\".",
      "",
      "Output rules:",
